...
class Arcface:
    def __init__(
        self,
        rec_name: str = "/models/trt-engines/arcface_r100_v1/arcface_r100_v1.plan",
        **kwargs,
    ):
...
class FaceGenderage:
    def __init__(
        self,
        rec_name: str = "/models/trt-engines/genderage_v1/genderage_v1.plan",
        **kwargs,
    ):
        self.rec_model = TrtModel(rec_name)
        self.input_shape = None
...
class DetectorInfer:
    def __init__(
        self,
        model="/models/trt-engines/centerface/centerface.plan",
        output_order=None,
        **kwargs,
    ):
